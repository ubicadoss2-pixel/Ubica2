...
router.get("/agenda", auth_middleware_1.optionalAuth, event_controller_1.agenda);
router.get("/place/:placeId", event_controller_1.listByPlace);
router.get("/pending", auth_middleware_1.authMiddleware, (0, role_middleware_1.authorize)("ADMIN"), event_controller_1.listPending);
...
router.patch("/:id/moderate", auth_middleware_1.authMiddleware, (0, role_middleware_1.authorize)("ADMIN"), event_controller_1.moderate);
