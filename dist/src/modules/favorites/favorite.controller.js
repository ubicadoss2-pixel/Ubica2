...
exports.toggleVisited = exports.list = exports.remove = exports.add = void 0;
...
const toggleVisited = async (req, res) => {
    try {
        const payload = favorite_schema_1.toggleVisitedSchema.parse(req.body);
        const placeId = req.params.placeId;
        const favorite = await (0, favorite_service_1.toggleFavoriteVisited)(req.user.id, placeId, payload.isVisited);
        res.json(favorite);
    }
    catch (error) {
        res.status(400).json({ message: error.message });
