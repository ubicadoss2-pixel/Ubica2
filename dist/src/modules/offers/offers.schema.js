...
const baseOfferSchema = zod_1.z.object({
...
exports.createOfferSchema = baseOfferSchema.refine((data) => data.endDate > data.startDate, {
    message: "End date must be after start date",
    path: ["endDate"],
});
exports.updateOfferSchema = baseOfferSchema.partial().refine((data) => {
